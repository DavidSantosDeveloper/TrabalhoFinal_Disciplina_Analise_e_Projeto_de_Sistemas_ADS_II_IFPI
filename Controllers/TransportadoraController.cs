...
namespace FranciscoDavidSantosSousa.Controllers
{
    public class TransportadoraController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTransportadora,nome,NotaDevendaId")] Transportadora transportadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTransportadora,nome,NotaDevendaId")] Transportadora transportadora)
        {
