...
namespace FranciscoDavidSantosSousa.Controllers
{
    public class MarcaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMarca,descricao,ProdutoId")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMarca,descricao,ProdutoId")] Marca marca)
        {
            if (id != marca.IdMarca)
            {
                return NotFound();
